...
//    object = new Sphere({0, -200, 0}, {0, 0, 90}, Color(0, 200, 100, 50), {});
//    toLoad.AddObject(object);
...
//    object = new Plan({500, 0, 0}, {0, 90, 0}, Color::red);
//    object->AddEffect(new LightPhong(0, 1, 30, 50, 0));
...
//    toLoad.AddObject(object);
    ...
    toLoad.AddSpot(new Spot({-1000, 0, 0}));
